...
const (
	...
	DefaultControllerName = "github.com/traefik/traefik/v3/pkg/provider/kubernetes/ingress-nginx/original-controller"
...
type Configuration struct {
	...
	// Defaults to "github.com/traefik/traefik/v3/pkg/provider/kubernetes/ingress-nginx/original-controller" defined in flags
	Controller string
