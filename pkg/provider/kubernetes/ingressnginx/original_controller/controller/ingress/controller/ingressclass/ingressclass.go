...
const (
	...
	DefaultControllerName = "github.com/traefik/traefik/v3/pkg/provider/kubernetes/ingress-nginx/original_controller"
...
type Configuration struct {
	...
	// Defaults to "github.com/traefik/traefik/v3/pkg/provider/kubernetes/ingress-nginx/original_controller" defined in flags
	Controller string
